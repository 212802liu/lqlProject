package com.example.common.core.util.sensitiveFilter;
...
public class SensitiveFilter implements Serializable{
    ...
    static {
        ...
        //                    SensitiveFilter.class.getClassLoader().getResourceAsStream(filePath)
...
//        }
            ...
            if(node != null){
                ...
                for(; node != null; node = node.next){
                    ...
                    if(node.headTwoCharMix == mix){
                        ...
                        if(desSet != null){
                            //descendingSet 返回此集合中包含的元素的逆序视图。 则表现为：从“色情电影”开始向前匹配
    ...
    public static void main(String[] args) {
        String a = SensitiveFilter.DEFAULT.filter("我不爱看色情电影，真的！！！sb搞笑",'*');
